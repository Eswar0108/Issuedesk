    ...
    <Layout>
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">Submit a bug, feature request, or task to your project workspace.</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Authentication token expires prematurely on refresh"
                required
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={6}
                placeholder="Provide a brief draft, then click 'AI Auto-Enhance' to format reproduction steps, expected behavior, and priority recommendations!"
